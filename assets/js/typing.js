function Typing(){
    var words = ["The reliable solution for professionals", "Extensive network and wide delivery capabilities", "Pricing based on fair principles","Excellent customer support"]
    var colors = ["#fff"]
